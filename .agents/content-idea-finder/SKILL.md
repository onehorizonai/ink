...
7. Editor: report the chosen idea in One Horizon with `report-feature-request`, using `references/idea-brief-template.md` as the description format.
...
- After approval, use `../content-creation-runner/SKILL.md` to turn planned `[Ink Idea]` records into reviewable `[Ink Draft]` initiatives.
