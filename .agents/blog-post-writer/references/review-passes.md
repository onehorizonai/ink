...
Each pass above is mandatory. Do not omit Ramsay review. Do not omit source URL check; if there are no URLs to inspect, run the pass and state that explicitly.
